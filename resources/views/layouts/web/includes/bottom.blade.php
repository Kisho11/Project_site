...
<script src="web/assets/rs-plugin/js/jquery.themepunch.tools.min.js"></script> 
<script src="web/assets/rs-plugin/js/jquery.themepunch.revolution.min.js"></script> 
<!-- Jquery Fancybox --> 
<script src="web/assets/js/jquery.fancybox.min.js"></script> 
<!-- Animate js --> 
<script src="web/assets/js/animate.js"></script> 
<script>
  new WOW().init();
</script> 
<!-- WOW file --> 
